...
const DATA = {
  ...
  fixtures: [
    ...
    { id:"f4", date:"2025-08-22", home:"t2", away:"t4", homeGoals:null, awayGoals:null, venue:"Field C", kickOff:"20:00" }
  ]
};
...
function renderMatchdayPage(date){
  ...
  function showAdminForm(fid){
    ...
    `;
    mdEl.prepend(panel);
    panel.querySelector('#score-form').addEventListener('submit', (ev)=>{
      ev.preventDefault();
    ...
    panel.querySelector('#clear-score').addEventListener('click', ()=>{
      f.homeGoals = null; f.awayGoals = null;
      renderMatchdayPage(date);
    });
  }
